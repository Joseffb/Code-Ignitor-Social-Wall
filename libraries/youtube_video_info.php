...
class youtube_video_info
{
    ...
    {
        $this->url2id();
        return '<iframe class="youtube-player" type="text/html" width="' . $width . '" height="' . $height . '" src="https://www.youtube.com/v/' . $this->id . '&fs=1"> allowfullscreen frameborder="0"></iframe>';
    }
    ...
    public function is_youtube_url($comments)
    {
        ...
        $youtube_preg = '~
                    ...
                    ~ix';
        //echo $comments;
        if (preg_match($youtube_preg, $comments, $match)) {
            ...
            $arrVid['key'] = $this->id;
            $arrVid['url'] = $this->url;
            $arrVid['thumb'] = "<img height='250' width='175' src='" . $this->thumb_url() . "' />";
            ...
            $arrVid['comments'] = preg_replace($youtube_preg, $set_link, $comments);
        }
